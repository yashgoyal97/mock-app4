define(["exports","./boot.js","../mixins/property-effects.js","../mixins/mutable-data.js","./settings.js","./wrap.js"],function(_exports,_boot,_propertyEffects,_mutableData,_settings,_wrap){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0/* ignoreName */ /* skipSlots */});_exports.templatize=templatize;_exports.modelForElement=modelForElement;_exports.TemplateInstanceBase=void 0;/**
@license
...
for(let iprop in props){this._setPendingProperty(iprop,props[iprop])}}/**
   ...
   * @return {void}
   */forwardHostProp(prop,value){if(this._setPendingPropertyOrPath(prop,value,/* ignoreName */!1/* skipSlots */ /* skipSlots */,!0)){this.__dataHost._enqueueClient(this)}}/**
