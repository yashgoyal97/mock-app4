define(["exports","../utils/boot.js","../utils/wrap.js","../utils/mixin.js","../utils/path.js","../utils/case-map.js","./property-accessors.js","./template-stamp.js","../utils/settings.js"],function(_exports,_boot,_wrap,_mixin,_path,_caseMap,_propertyAccessors,_templateStamp,_settings){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0/* ignoreName */ /* skipSlots */});_exports.PropertyEffects=void 0;/**
 * @fileoverview
 ...
 * @private
 */function runEffects(inst,effects,props,oldProps,hasPaths,extraArgs){if(effects){let ran=/* ignoreName */!1/* skipSlots */ /* skipSlots */,id=dedupeId++;for(let prop in props){if(runEffectsForProperty(inst,/** @type {!Object} */effects,id,prop,props,oldProps,hasPaths,extraArgs)){ran=!0}}return ran}return!1}/**
