define(["exports","../utils/boot.js","../utils/mixin.js","../utils/telemetry.js","./properties-changed.js"],function(_exports,_boot,_mixin,_telemetry,_propertiesChanged){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0/* ignoreName */ /* skipSlots */});_exports.PropertiesMixin=void 0;/**
@license
...
return superCtor.prototype instanceof PropertiesMixin?/** @type {!PropertiesMixinConstructor} */superCtor:null}/**
  ...
  */class PropertiesMixin extends base{/**
    ...
    * @nocollapse
    */static get observedAttributes(){if(!this.hasOwnProperty(JSCompiler_renameProperty("__observedAttributes",this))){(0,_telemetry.register)(this.prototype);const props=this._properties;this.__observedAttributes=props?Object.keys(props).map(p=>this.attributeNameForProperty(p)):[]}return this.__observedAttributes}/**
