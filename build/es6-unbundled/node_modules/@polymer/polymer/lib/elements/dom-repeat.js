...
if(this.__isDetached){this.__isDetached=/* ignoreName */!1/* skipSlots */ /* skipSlots */;let wrappedParent=(0,_wrap.wrap)((0,_wrap.wrap)(this).parentNode);for(let i=0;i<this.__instances.length;i++){this.__attachInstance(i,wrappedParent)}}}__ensureTemplatized(){// Templatizing (generating the instance constructor) needs to wait
