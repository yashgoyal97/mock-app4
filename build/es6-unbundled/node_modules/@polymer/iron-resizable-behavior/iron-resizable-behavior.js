define(["exports","../polymer/polymer-legacy.js","../polymer/lib/legacy/polymer.dom.js","../polymer/lib/utils/settings.js"],function(_exports,_polymerLegacy,_polymerDom,_settings){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0/* ignoreName */ /* skipSlots */});_exports.IronResizableBehavior=void 0;/**
@license
 ...
 **/const IronResizableBehavior={properties:{/**
     ...
     * resize.
     */_notifyingDescendant:{type:Boolean,value:/* ignoreName */!1/* skipSlots */ /* skipSlots */}},listeners:{"iron-request-resize-notifications":"_onIronRequestResizeNotifications"},created:function(){// We don't really need property effects on these, and also we want them
