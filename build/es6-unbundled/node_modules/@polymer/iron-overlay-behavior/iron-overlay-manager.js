...
if(!active||/* ignoreName */!1/* skipSlots */ /* skipSlots */===active instanceof Element){active=document.body}while(active.root&&(0,_polymerDom.dom)(active.root).activeElement){active=(0,_polymerDom.dom)(active.root).activeElement}return active}/**
