define(["exports","../polymer/polymer-legacy.js"],function(_exports,_polymerLegacy){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0/* ignoreName */ /* skipSlots */});_exports.IronSelection=void 0;/**
@license
...
*/class IronSelection{/**
   ...
   */clear(excludes){this.selection.slice().forEach(function(item){if(!excludes||0>excludes.indexOf(item)){this.setItemSelected(item,/* ignoreName */!1/* skipSlots */ /* skipSlots */)}},this)}/**
