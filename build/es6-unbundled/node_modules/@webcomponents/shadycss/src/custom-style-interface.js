...
*/'use strict';Object.defineProperty(_exports,"__esModule",{value:!0/* ignoreName */ /* skipSlots */});_exports.CustomStyleInterfaceInterface=_exports.default=_exports.CustomStyleProvider=void 0;_documentWait=babelHelpers.interopRequireDefault(_documentWait);/**
...
@unrestricted
*/class CustomStyleInterface{constructor(){/** @type {!Array<!CustomStyleProvider>} */this.customStyles=[];this.enqueued=/* ignoreName */!1/* skipSlots */ /* skipSlots */;// NOTE(dfreedm): use quotes here to prevent closure inlining to `function(){}`;
