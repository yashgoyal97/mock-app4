...
</iron-iconset-svg>`;document.head.appendChild(template$1.content);var ORPHANS=new Set;/**
...
activateEvent:{type:String,value:null}},observers:["_selectedPageChanged(selected)"],_selectedPageChanged:function(selected,old){this.async(this.notifyResize)}});var Utility={distance:function(x1,y1,x2,y2){var xDelta=x1-x2,yDelta=y1-y2;return Math.sqrt(xDelta*xDelta+yDelta*yDelta)},now:window.performance&&window.performance.now?window.performance.now.bind(window.performance):Date.now};/**
    * @param {HTMLElement} element
    * @constructor
...
if(this.hasRipple()&&1>this.getRipple().ripples.length){this._ripple.uiDownAction()}},/**
   ...
   *
   * @param {!KeyboardEvent} event .
   */_spaceKeyUpHandler:function(event){IronButtonStateImpl._spaceKeyUpHandler.call(this,event);if(this.hasRipple()){this._ripple.uiUpAction()}}};/** @polymerBehavior */_exports.PaperButtonBehaviorImpl=PaperButtonBehaviorImpl;const PaperButtonBehavior=[IronButtonState,IronControlState,PaperRippleBehavior,PaperButtonBehaviorImpl];_exports.PaperButtonBehavior=PaperButtonBehavior;var paperButtonBehavior={PaperButtonBehaviorImpl:PaperButtonBehaviorImpl,PaperButtonBehavior:PaperButtonBehavior};_exports.$paperButtonBehavior=paperButtonBehavior;const template$2=html`
<custom-style>
  <style is="custom-style">
    html {
...
<custom-style>
  <style is="custom-style">
...
</custom-style>`;template$6.setAttribute("style","display: none;");document.head.appendChild(template$6.content);setPassiveTouchGestures(!0);setRootPath(MyAppGlobals.rootPath);/**
                                     * @customElement
                                     * @polymer
                                     */class MockApp4App extends PolymerElement{static get template(){return html`
     ...
     * 
     * @param {String} page 
     */_pageChanged(page){switch(page){case"login":new Promise((res,rej)=>_require.default(["./login-page.js"],res,rej)).then(bundle=>bundle&&bundle.$loginPage||{});break;case"dashboard":new Promise((res,rej)=>_require.default(["./dashboard-page.js"],res,rej)).then(bundle=>bundle&&bundle.$dashboardPage||{});break;case"view404":new Promise((res,rej)=>_require.default(["./view404-page.js"],res,rej)).then(bundle=>bundle&&bundle.$view404Page||{});break;}}}window.customElements.define("mock-app4-app",MockApp4App)});