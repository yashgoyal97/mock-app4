...
}}};/** @polymerBehavior */_exports.IronButtonStateImpl=IronButtonStateImpl;var IronButtonState=[IronA11yKeysBehavior,IronButtonStateImpl];_exports.IronButtonState=IronButtonState;var ironButtonState={IronButtonStateImpl:IronButtonStateImpl,IronButtonState:IronButtonState};_exports.$ironButtonState=ironButtonState;var template=html(_templateObject2_1d48fc504da011ea8faf35a9b7563db5());template.setAttribute("style","display: none;");document.head.appendChild(template.content);var style=document.createElement("style");style.textContent="[hidden] { display: none !important; }";document.head.appendChild(style);var IronMeta=/*#__PURE__*/function(){/**
   * @param {{
...
IronMeta[" "]=function(){};IronMeta.types={};var metaDatas=IronMeta.types;/**
   ...
   * @return {*}
   */byKey:function byKey(key){return new IronMeta({type:this.type,key:key}).value}});var ironMeta={IronMeta:IronMeta};_exports.$ironMeta=ironMeta;Polymer({_template:html(_templateObject3_1d48fc504da011ea8faf35a9b7563db5()),is:"iron-icon",properties:{/**
...
// shadow-root
svg.style.cssText=cssText;svg.appendChild(content).removeAttribute("id");return svg}return null}});var template$1=html(_templateObject4_1d48fc504da011ea8faf35a9b7563db5());document.head.appendChild(template$1.content);var ORPHANS=new Set,IronResizableBehavior={properties:{/**
...
this._parentResizable._interestedResizables.forEach(function(resizable){if(resizable!==this){resizable._findParent()}},this)}}},_findParent:function _findParent(){this.assignParentResizable(null);this.fire("iron-request-resize-notifications",null,{node:this,bubbles:!0,cancelable:!0});if(!this._parentResizable){ORPHANS.add(this)}else{ORPHANS.delete(this)}}};/**
                          ...
                          * @polymerBehavior
                          * @demo demo/index.html
                          **/_exports.IronResizableBehavior=IronResizableBehavior;var ironResizableBehavior={IronResizableBehavior:IronResizableBehavior};_exports.$ironResizableBehavior=ironResizableBehavior;var IronSelection=/*#__PURE__*/function(){/**
...
this.waveContainer.style.webkitTransform="translate("+dx+"px, "+dy+"px)";this.waveContainer.style.transform="translate3d("+dx+"px, "+dy+"px, 0)";this.wave.style.webkitTransform="scale("+scale+","+scale+")";this.wave.style.transform="scale3d("+scale+","+scale+",1)"},/** @param {Event=} event */downAction:function downAction(event){var xCenter=this.containerMetrics.width/2,yCenter=this.containerMetrics.height/2;this.resetInteractionState();this.mouseDownStart=Utility.now();if(this.center){this.xStart=xCenter;this.yStart=yCenter;this.slideDistance=Utility.distance(this.xStart,this.yStart,this.xEnd,this.yEnd)}else{this.xStart=event?event.detail.x-this.containerMetrics.boundingRect.left:this.containerMetrics.width/2;this.yStart=event?event.detail.y-this.containerMetrics.boundingRect.top:this.containerMetrics.height/2}if(this.recenters){this.xEnd=xCenter;this.yEnd=yCenter;this.slideDistance=Utility.distance(this.xStart,this.yStart,this.xEnd,this.yEnd)}this.maxRadius=this.containerMetrics.furthestCornerDistanceFrom(this.xStart,this.yStart);this.waveContainer.style.top=(this.containerMetrics.height-this.containerMetrics.size)/2+"px";this.waveContainer.style.left=(this.containerMetrics.width-this.containerMetrics.size)/2+"px";this.waveContainer.style.width=this.containerMetrics.size+"px";this.waveContainer.style.height=this.containerMetrics.size+"px"},/** @param {Event=} event */upAction:function upAction(event){if(!this.isMouseDown){return}this.mouseUpStart=Utility.now()},remove:function remove(){dom(dom(this.waveContainer).parentNode).removeChild(this.waveContainer)}};/**
   ...
   @demo demo/index.html
   */Polymer({/** @override */_template:html(_templateObject6_1d48fc504da011ea8faf35a9b7563db5()),is:"paper-ripple",behaviors:[IronA11yKeysBehavior],properties:{/**
...
if(this.hasRipple()&&1>this.getRipple().ripples.length){this._ripple.uiDownAction()}},/**
   ...
   *
   * @param {!KeyboardEvent} event .
   */_spaceKeyUpHandler:function _spaceKeyUpHandler(event){IronButtonStateImpl._spaceKeyUpHandler.call(this,event);if(this.hasRipple()){this._ripple.uiUpAction()}}};/** @polymerBehavior */_exports.PaperButtonBehaviorImpl=PaperButtonBehaviorImpl;var PaperButtonBehavior=[IronButtonState,IronControlState,PaperRippleBehavior,PaperButtonBehaviorImpl];_exports.PaperButtonBehavior=PaperButtonBehavior;var paperButtonBehavior={PaperButtonBehaviorImpl:PaperButtonBehaviorImpl,PaperButtonBehavior:PaperButtonBehavior};_exports.$paperButtonBehavior=paperButtonBehavior;var template$2=html(_templateObject7_1d48fc504da011ea8faf35a9b7563db5());template$2.setAttribute("style","display: none;");document.head.appendChild(template$2.content);var template$3=html(_templateObject8_1d48fc504da011ea8faf35a9b7563db5());template$3.setAttribute("style","display: none;");document.head.appendChild(template$3.content);var template$4=html(_templateObject9_1d48fc504da011ea8faf35a9b7563db5());template$4.setAttribute("strip-whitespace","");/**
                                                 Material design:
    ...
    */});var template$5=html(_templateObject10_1d48fc504da011ea8faf35a9b7563db5());template$5.setAttribute("style","display: none;");document.head.appendChild(template$5.content);var template$6=html(_templateObject11_1d48fc504da011ea8faf35a9b7563db5());template$6.setAttribute("style","display: none;");document.head.appendChild(template$6.content);setPassiveTouchGestures(!0);setRootPath(MyAppGlobals.rootPath);/**
                                     * @customElement
                                     * @polymer
                                     */var MockApp4App=/*#__PURE__*/function(_PolymerElement2){babelHelpers.inherits(MockApp4App,_PolymerElement2);function MockApp4App(){babelHelpers.classCallCheck(this,MockApp4App);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(MockApp4App).apply(this,arguments))}babelHelpers.createClass(MockApp4App,[{key:"ready",value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(MockApp4App.prototype),"ready",this).call(this);this.addEventListener("refresh-dashboard",function(event){console.log(sessionStorage.getItem("doctorId"),"main");console.log(sessionStorage.getItem("doctorName"),"main");this.$.dashboard._handleUserLogIn()})}/**
     * 
     * @param {String} page 
     */},{key:"_routePageChanged",value:function _routePageChanged(page){if(!page){this.page="login"}else if(-1!==["login","dashboard"].indexOf(page)){this.page=page}else{this.page="view404"}}/**
     * 
     * @param {String} page 
     */},{key:"_pageChanged",value:function _pageChanged(page){switch(page){case"login":new Promise(function(res,rej){return _require.default(["./login-page.js"],res,rej)}).then(function(bundle){return bundle&&bundle.$loginPage||{}});break;case"dashboard":new Promise(function(res,rej){return _require.default(["./dashboard-page.js"],res,rej)}).then(function(bundle){return bundle&&bundle.$dashboardPage||{}});break;case"view404":new Promise(function(res,rej){return _require.default(["./view404-page.js"],res,rej)}).then(function(bundle){return bundle&&bundle.$view404Page||{}});break;}}}],[{key:"template",get:function get(){return html(_templateObject12_1d48fc504da011ea8faf35a9b7563db5())}},{key:"properties",get:function get(){return{page:{type:String,reflectToAttribute:!0,observer:"_pageChanged"},routeData:Object,subroute:Object,userData:Object,accountData:{type:Array}}}},{key:"observers",get:function get(){return["_routePageChanged(routeData.page)"]}}]);return MockApp4App}(PolymerElement);window.customElements.define("mock-app4-app",MockApp4App)});